...
export const MOCK_EXPLANATIONS = {
    Hemoglobin: {
        ...
        meaning: "Hemoglobin carries oxygen from your lungs to the rest of your body. Yours is below the typical range, which can leave you feeling tired or short of breath and usually points to iron levels worth checking.",
        helps: [
    ...
    "LDL Cholesterol": {
        ...
        meaning: "LDL is the cholesterol that can build up in your artery walls over time. Yours is well above the target, which raises long-term risk for heart disease if it stays there.",
        helps: [
    ...
    HbA1c: {
        ...
        meaning: "HbA1c reflects your average blood sugar over the last 2–3 months. Yours sits just above the normal range, in the range doctors call prediabetes — it's a signal to act now, not a diagnosis.",
        helps: [
    ...
    "Vitamin D": {
        ...
        meaning: "Vitamin D supports bone health, muscle function and immune response. Yours is just under the normal range — common if you get limited sun exposure — and is easy to correct.",
        helps: [
    ...
    "Fasting Glucose": {
        ...
        meaning: "This measures blood sugar after a period without eating. Yours is comfortably within the normal range, with no signs of insulin resistance.",
    ...
    TSH: {
        ...
        meaning: "TSH signals your thyroid to produce hormone — a slightly high reading can mean your thyroid is working a little harder than usual to keep hormone levels normal.",
        helps: [
